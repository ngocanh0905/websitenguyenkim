 ...
 * @author tannguyen
 */
@WebServlet(name="GetCommodityTypeAll", urlPatterns={"/GetCommodityTypeAll"})
public class GetCommodityTypeAll extends HttpServlet {
    ...
    throws ServletException, IOException, Exception {
        ...
        if(mode == ActionMode.Get){
            ...
            String url = "/pages/catalogue.jsp";
    ...
    throws ServletException, IOException {
        try {
            ...
            Logger.getLogger(GetCommodityTypeAll.class.getName()).log(Level.SEVERE, null, ex);
        }
    } 
